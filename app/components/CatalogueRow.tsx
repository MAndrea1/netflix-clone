  ...
  return (
    <div className='mt-4 md:mt-6'>
      ...
      <div className='group relative hover:transition-all'>
        <div className={`hidden absolute z-50 items-center cursor-pointer transition duration-500 hover:bg-stone-950 hover:bg-opacity-50 ${moved === 1 && 'md:flex'} md:h-44 md:pb-2 md:items-center lg:h-36`} onClick={() => handleClick(1)}>
        ...
        <div className={`hidden absolute right-0 top-0 z-50 items-center cursor-pointer transition duration-500 hover:bg-stone-950 hover:bg-opacity-50 md:flex md:h-44 md:pb-2 md:items-center lg:h-36`} onClick={() => handleClick(-1)}>
          <span className={`clickable drop-shadow-md text-4xl px-3 lg:text-5xl lg:px-4`}>›</span>
        </div>
      </div>
    </div>
