...
const banner = ({fetchPopular}: movieList) => {
  ...
  return (
    <div className='flex flex-col align-bottom h-60 landscape:h-96 md:h-[55vh] lg:h-[95vh]'>
      <div className='absolute top-0 left-0 w-full h-60 landscape:h-96 md:h-[55vh] lg:h-[95vh] -z-10'>
        <Image 
          ...
          priority={true}
        ></Image>
        <div className='absolute bg-gradient-to-t from-stone-950 from-20% bottom-0 w-full h-28 landscape:h-60 md:h-[32vh] lg:h-[55vh] z-0'></div>
      </div>
      <div className='mt-auto px-8 mb-16 landscape:mb-5 md:mb-24 lg:mb-52 lg:px-20'>
