    ...
    <div className='flex w-full justify-center items-center'>
      <div className='pt-20 px-3 pb-10 md:mx-8 w-full lg:w-[1000px] bg-grey'>
        ...
        <ul className='grid grid-cols-2 md:grid-cols-4 gap-4 text-xs text-stone-500 mb-10'>
          ...
          <li className='footerLink'>Cookie Preferences</li>
        ...
        <span className='text-xs py-2 px-2 text-stone-500 hover:text-white border border-stone-500 cursor-pointer'>Service Code</span>
      </div>
    </div>
  )
}
