...
const TvPage = async () => {
  const url = `https://api.themoviedb.org/3/discover/tv?api_key=${process.env.NEXT_PUBLIC_API_KEY}&include_adult=false&language=en-US`
  ...
  return (
    <>
      ...
      <h1 className='drop-shadow-lg font-bold text-xl md:text-3xl md:py-4 lg:py-8 lg:text-5xl'>Tv Shows</h1>
