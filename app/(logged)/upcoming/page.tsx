...
const MoviesPage = async () => {
  const url = `https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1&api_key=${process.env.NEXT_PUBLIC_API_KEY}`
  ...
  return (
    <>
      ...
      <h1 className='drop-shadow-lg font-bold text-xl md:text-3xl md:py-4 lg:py-8 lg:text-5xl'>Upcoming</h1>
